...
using Microsoft.eShopWeb.ApplicationCore.ExternalService;
...
public class OrderService : IOrderService
{
    ...
    public OrderService(IRepository<Basket> basketRepository,
        ...
        IUriComposer uriComposer, IMediator mediator, IAzureFunctionClient azureFunctionClient, IServiceBusClientWrapper serviceBusClientWrapper)
    {
    ...
    public async Task CreateOrderAsync(int basketId, Address shippingAddress)
    {
        ...
        await _azureFunctionClient.ExecuteAsync(order);
        await _serviceBusClientWrapper.SendMessageAsync(order);
